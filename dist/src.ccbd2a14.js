...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/lit-html/lib/directive.js":[function(require,module,exports) {
'use strict';
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const isCEPolyfill = exports.isCEPolyfill = window.customElements !== undefined && window.customElements.polyfillWrapFlushCallback !== undefined;
/**
...
const rewritesStyleAttribute = exports.rewritesStyleAttribute = (() => {
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const isPrimitive = exports.isPrimitive = value => value === null || !(typeof value === 'object' || typeof value === 'function');
/**
...
class NodePart {
    ...
    _commitTemplateResult(value) {
        ...
        if (this.value && this.value.template === template) {
            ...
            instance = new _templateInstance.TemplateInstance(template, value.processor, this.templateFactory);
            const fragment = instance._clone();
            // Since we cloned in the polyfill case, now force an upgrade
            if (_dom.isCEPolyfill && !this.endNode.isConnected) {
...
exports.templateInstances = undefined;
...
const templateInstances = exports.templateInstances = new WeakMap();
/**
...
function render(result, container, templateFactory = _templateFactory.templateFactory) {
    ...
    if (instance !== undefined && instance.template === template && instance.processor === result.processor) {
        instance.update(result.values);
        return;
    }
    // First render, create a new TemplateInstance and append it
    instance = new _templateInstance.TemplateInstance(template, result.processor, templateFactory);
    templateInstances.set(container, instance);
    const fragment = instance._clone();
    (0, _dom.removeNodes)(container, container.firstChild);
    // Since we cloned in the polyfill case, now force an upgrade
    if (_dom.isCEPolyfill && !container.isConnected) {
        document.adoptNode(fragment);
        customElements.upgrade(fragment);
    }
...
},{"./dom.js":"../node_modules/lit-html/lib/dom.js","./template-factory.js":"../node_modules/lit-html/lib/template-factory.js","./template-instance.js":"../node_modules/lit-html/lib/template-instance.js"}],"../node_modules/lit-html/lit-html.js":[function(require,module,exports) {
'use strict';
...
var fetchAll = exports.fetchAll = function () {
...
var _templateObject = _taggedTemplateLiteral(['\n<h4 class="index__title">\n  <a href="/" class="index__title-link">\n    Galactic Pigs: A Prelude\n  </a>\n</h4>'], ['\n<h4 class="index__title">\n  <a href="/" class="index__title-link">\n    Galactic Pigs: A Prelude\n  </a>\n</h4>']),
    _templateObject2 = _taggedTemplateLiteral(['<div class="index__text">', '</div>'], ['<div class="index__text">', '</div>']),
    _templateObject3 = _taggedTemplateLiteral(['<div class="index__prompt">', '</div>'], ['<div class="index__prompt">', '</div>']),
    _templateObject4 = _taggedTemplateLiteral(['\n  <div class="index__choice">\n    <a href="', '" class="index__choice-button">', '</a>\n  </div>\n'], ['\n  <div class="index__choice">\n    <a href="', '" class="index__choice-button">', '</a>\n  </div>\n']),
...
var _data = require('../narratives/data');
...
var text = function text(props) {
  return (0, _litHtml.html)(_templateObject2, props.narrative.text);
};

var prompt = function prompt(props) {
  return (0, _litHtml.html)(_templateObject3, props.narrative.prompt);
};

var choice = function choice(props) {
  return (0, _litHtml.html)(_templateObject4, props.narrative.id, props.narrative.choiceText);
};
var getChoices = function getChoices(props) {
  return props.store.data.filter(function (n) {
    return Array.isArray(props.narrative.choices) && props.narrative.choices.some(function (id) {
      return id === n.id;
    });
  });
};

var choices = function choices(props) {
  return (0, _litHtml.html)(_templateObject5, getChoices(props).map(function (n) {
    return choice({ narrative: n, store: props.store });
  }));
};

var index = function index(props) {
  return (0, _litHtml.html)(_templateObject6, title(props), text(props), prompt(props), choices(props), prompt(props), choices(props));
};

exports.default = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ctx) {
    var data, store, routeId, narrative;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _data.fetchAll)();
          ...
          case 2:
            ...
            routeId = parseInt(ctx.params.id, 10);
            narrative = store.data.find(function (n) {
              return n.id === routeId;
            });

            if (narrative) {
              (0, _litHtml.render)(index({ narrative: narrative, store: store }), document.getElementById('app'));
            } else {
              console.log('lameo');
            }
...
},{"lit-html":"../node_modules/lit-html/lit-html.js","../narratives/data":"../src/narratives/data.js"}],"../src/routes.js":[function(require,module,exports) {
'use strict';
...
var map = exports.map = function map() {
  (0, _page2.default)('/', function (_) {
    return _page2.default.redirect('/1');
  });
  (0, _page2.default)('/:id', _index2.default);
  (0, _page2.default)();
};
},{"page":"../node_modules/page/page.js","./pages/index":"../src/pages/index.js"}],"../src/index.js":[function(require,module,exports) {
'use strict';
...
routes.map();
},{"./routes":"../src/routes.js"}],"../node_modules/parcel-bundler/lib/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.ccbd2a14.map